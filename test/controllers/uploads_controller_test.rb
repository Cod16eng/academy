...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { speaker_id: @upload.speaker_id, upload: @upload.upload, webinar_id: @upload.webinar_id } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { speaker_id: @upload.speaker_id, upload: @upload.upload, webinar_id: @upload.webinar_id } }
